...
az vm create --resource-group $RG -n $VM01 -l $L --image Win2019DataCenter --admin-username $user --admin-password $pass --size $size1 --public-ip-address $Pip01 --public-ip-address-allocation static --subnet $SUBNETID --license-type Windows_Server --nsg ""


az vm attach -g Datas --vm-name DTVM01 --name Datas --new

az lock create --name Dont --resource-group $RG --lock-type CanNotDelete
